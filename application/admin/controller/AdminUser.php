...
class AdminUser extends AdminBase
{
    ...
    public function index()
    {
        ...
        $access = $this->auth_group_access_model->column('group_id', 'uid');

        $groupName = $this->auth_group_model->column('title', 'id');

        return $this->fetch('index', ['admin_user_list' => $admin_user_list, 'access' => $access, 'groupName' => $groupName]);
    }
